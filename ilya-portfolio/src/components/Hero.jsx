...
import minBild from "../assets/min-bild.png";  // rätt import
  ...
  return (
    <section id="hero" className="hero-section">
      <div className="hero-content">
        <img 
          src={minBild}   // använd variabeln här
        ...
        <div className="hero-buttons">
          <a href="https://github.com/ilyafredriksson" className="btn-primary">GitHub</a>
